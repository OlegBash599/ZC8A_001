...
main ()
{
char double_type_output[32];
double res_jw = 1.1;
char char_ying[32] = "Dunningham";
char char_yang[32] = "Cunnigham";
int max_size = 0;
long y_length_in = 0;
int *ind_c_in[1];
...
if ( length_word1 > length_word2 ){
    ...
    max_size = length_word2;
}
// printf("Max size Length of word is %ld symbols", max_size); 
//////////////////////////////////
...
sprintf (double_type_output, "%f", res_jw);
printf("\n res_jw = %s \n",double_type_output);
// print(strcmp95('qwert', 'qweras', 11, 0));
return 0;
